...
;src/player.c:55: void init_speed(void){
;	---------------------------------
; Function init_speed
; ---------------------------------
_init_speed::
...
;src/player.c:56: move_x_per_frame.w = 0;
...
;src/player.c:57: move_y_per_frame.w = 0;
...
;src/player.c:58: scroll_x_per_frame.w = 0;
...
;src/player.c:59: scroll_y_per_frame.w = 0;
...
;src/player.c:319: if (depth <= EARTH_START) player.fuel.current_value = player.fuel.max_value;
	ld	a, #0x05
	ld	hl, #_depth
	sub	a, (hl)
	ret	C
...
;src/player.c:325: currentGameState = GAME_STATE_UPGRADE_MENU;
