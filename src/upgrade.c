...
void write_main_upgrade_text(void) {
    ...
    strcat(money_string, "$");
    // line 1
    draw_text(WIN, 3, 2, "UPGRADE STORE", 14, TRUE, 0);
    // line 2
    draw_text(WIN, 3, 3, attributes_numbers[current_upgrade_menu->current_upgrade_selection]->attribute_name, 14, TRUE, 0);
    //draw_text(WIN, 3, 3, attributes_numbers[selection]->upgrade_name[attributes_numbers[selection]->upgrade_level], 14, TRUE, 0);
    // line 3
    draw_text(WIN, 3, 15, "CASH", 5, TRUE, 0);
    draw_text(WIN, 8, 15, money_string, 9, FALSE, 0);
}
...
void write_sub_upgrade_text(void) {
    ...
    // line 1
    draw_text(WIN, 3, 2, upgrade_string, 8, TRUE, 0);
    draw_text(WIN, 11, 2, cost_string, 5, FALSE, 0);
    draw_text(WIN, 16, 2, "$", 1, TRUE, 0);
    // line 2
    draw_text(WIN, 3, 3, attributes_numbers[current_upgrade_state]->upgrade_name[current_upgrade_menu->current_upgrade_selection], 14, TRUE, 0);
    // line 3
    draw_text(WIN, 3, 15, "CASH", 5, TRUE, 0);
    draw_text(WIN, 8, 15, money_string, 9, FALSE, 0);
}
