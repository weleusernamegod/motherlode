...
#define splashscreen_TILE_COUNT 196
#define splashscreen_PALETTE_COUNT 7
#define splashscreen_COLORS_PER_PALETTE 4
#define splashscreen_TOTAL_COLORS 28
...
extern const palette_color_t splashscreen_palettes[28];
extern const uint8_t splashscreen_tiles[3136];
