...
png2asset:
	...
	$(PNG2ASSET) png/upgrade_tiles.png -c assets/upgrade_tiles.c -spr8x8 -noflip -keep_palette_order -max_palettes 36 -keep_duplicate_tiles -tile_origin 160 -b 2
	$(PNG2ASSET) png/upgrade_tick.png -c assets/upgrade_tick.c -spr8x8 -noflip -keep_palette_order -tile_origin 32 -b 2
	$(PNG2ASSET) png/upgrade_frame.png -c assets/upgrade_frame.c -spr8x8 -map -noflip -tile_origin 144 -b 2
	$(PNG2ASSET) png/sell_frame.png -c assets/sell_frame.c -spr8x8 -map -noflip -tile_origin 144 -b 3
	$(PNG2ASSET) png/powerup_frame.png -c assets/powerup_frame.c -spr8x8 -map -repair_indexed_pal -keep_palette_order -use_map_attributes -tile_origin 144 -noflip -b 3
